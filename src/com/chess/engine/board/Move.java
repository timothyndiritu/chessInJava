...
public abstract class Move {
  ...
  public Board execute() {
    ...
    builder.setMoveMaker(
      this.board.currentPlayer().getOpponent().getAlliance()
    );
  ...
  public static class MajorAttackMove extends AttackMove {
    ...
    public boolean equals(final Object other) {
      return (
        this == other ||
        (other instanceof MajorAttackMove && super.equals(other))
      );
    }
  ...
  public static final class MajorMove extends Move {
    ...
    public boolean equals(final Object other) {
      return (
        this == other || (other instanceof MajorMove && super.equals(other))
      );
    }
  ...
  public static final class PawnMove extends Move {
    ...
    public boolean equals(final Object other) {
      return (
        this == other || (other instanceof PawnMove && super.equals(other))
      );
    }
  ...
  public static class PawnAttackMove extends AttackMove {
    ...
    public boolean equals(final Object other) {
      return (
        this == other ||
        (other instanceof PawnAttackMove && super.equals(other))
      );
    }
    ...
    public String toString() {
      return (
        BoardUtils.getPositionAtCoordinate(
  ...
  public static final class PawnEnPassantAttackMove extends PawnAttackMove {
    ...
    public boolean equals(final Object other) {
      return (
        this == other ||
        (other instanceof PawnEnPassantAttackMove && super.equals(other))
      );
    }
  ...
  public static class PawnPromotion extends Move {
    ...
    public boolean equals(final Object other) {
      return (
        this == other || (other instanceof PawnPromotion && super.equals(other))
      );
    }
    ...
    public Board execute() {
      ...
      for (final Piece piece : pawnMovedBoard
        .currentPlayer()
        .getActivePieces()) {
  ...
  abstract static class CastleMove extends Move {
    ...
    protected final int castleRookDesination;
    ...
    public CastleMove(
      ...
      final int castleRookDesination
    ) {
      super(board, movedPiece, destinationCoordinate);
      this.castleRook = castleRook;
      this.castleRookStart = castleRookStart;
      this.castleRookDesination = castleRookDesination;
    }
    ...
    public Board execute() {
      ...
      builder.setPiece(
        new Rook(this.castleRookDesination, this.castleRook.getPieceAlliance())
      );
      builder.setMoveMaker(
        this.board.currentPlayer().getOpponent().getAlliance()
      );
    ...
    public int hashCode() {
      ...
      result = prime * result + this.castleRookDesination;
      return result;
    }
