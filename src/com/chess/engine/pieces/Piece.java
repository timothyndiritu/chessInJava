...
public abstract class Piece {
    ...
    private final int catchedHashCode;
    ...
    public Piece(final PieceType pieceType, final int piecePosition, final Alliance pieceAlliance, final boolean isFirstMove) {
        ...
        this.pieceAlliance = pieceAlliance; // Set the alliance explicitly here
        this.piecePosition = piecePosition;
        this.isFirstMove = isFirstMove;
        this.catchedHashCode = computeHashCode();
    }
